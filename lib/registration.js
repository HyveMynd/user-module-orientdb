...
var Registration  = function (UserRepo) {
    ...
    var sendVerificationEmail = function () {
        ...
        this.mailOptions.html = '<b>Please follow the link below to verify your account.</b><br/><br/><a href="'+link+'"/> Click to Verify';
    ...
    self.sendVerificationEmail = function (email, transporter, mailOptions) {
        ...
        }).bind({email: email, transporter: transporter, mailOptions: mailOptions})
            .then(getUser)
